  ...
  function get_bitly_long_urls($links){
  	...
  	foreach($infos as $info){
  		...
  		if($info['long_url'] && strlen($info['long_url']) > 0){
  			// echo("setting long url transient for 'bitly_url_long_" . $info['short_url'] . "<br />");
	...
	function widget($args, $instance)
	{
		...
		// echo "<br \><br \><span style=''>Powered by <img src='http://static.bitly.com/graphics/logo/bitly_logo.png' style='height:45px;vertical-align:middle'></span>";
